    ...
    return (
        <section className="max-container min-h-screen flex items-center justify-center py-[10rem]">
            <h1 className="font-bold leading-[0.85] text-justify uppercase break-words px-[10rem]">
                ...
                I&apos;VE BEEN WRITING CODE SINCE I WAS A KID IN 2016. I REFUSE
                TO PICK JUST ONE SIDE. ML, APP DEV, GAME DEV, WEB—I&apos;VE DONE
                IT ALL AND I&apos;M READY FOR MORE. I BUILD DIGITAL EXPERIENCES
                THAT ARE TOO LOUD TO IGNORE. IF YOU&apos;RE TIRED OF BASIC
                SITES, YOU&apos;RE IN THE RIGHT PLACE. SCROLL DOWN TO WITNESS
                THE EVOLUTION.
            </h1>
        </section>
    )
